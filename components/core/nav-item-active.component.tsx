    ...
    >
      ...
      >
        <svg xmlns='http://www.w3.org/2000/svg' width='6.9' height='6.1' viewBox='0 0 6.9 6.1'>
          <g><path fill={colors.brand[300]} d='M3.5,0,0,6.1H6.9ZM1.3,5.4,3.5,1.6,5.7,5.4H1.3Z' /></g>
        </svg>
      </Box>
      <Box
        d='flex'
      ...
      <Box
        ...
        >
          <svg xmlns='http://www.w3.org/2000/svg' width='6.2' height='6.2' viewBox='0 0 6.2 6.2'>
            <g><path fill={colors.brand[400]} d='M3.1,0A3.1,3.1,0,0,0,0,3.1,3.1,3.1,0,0,0,3.1,6.2,3.1,3.1,0,0,0,6.2,3.1,3.1,3.1,0,0,0,3.1,0Zm0,5.4A2.3,2.3,0,0,1,.8,3.1,2.3,2.3,0,0,1,3.1.8,2.3,2.3,0,0,1,5.4,3.1,2.4,2.4,0,0,1,3.1,5.4Z'/></g>
          </svg>
        </Box>
        <svg xmlns='http://www.w3.org/2000/svg' width='5' height='10' viewBox='0 0 5 10'>
